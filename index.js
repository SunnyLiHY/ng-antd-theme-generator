    ...
    return new Promise((resolve, reject) => {
      ...
      */
        ...
        if (antdStylesDir) {
            ...
            antdPath = path.join(antDir, 'style');
        }
        const entry = path.join(antdPath, './index.less');
        const styles = glob.sync(path.join(antDir, './*/style/index.less'));
        ...
        */
        varFile = varFile || path.join(antdPath, "./themes/default.less");
